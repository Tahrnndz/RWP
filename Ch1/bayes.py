...
class Search():
    ...
    def draw_map(self, last_known):
        """Displays basemap with scale, last known xy location, search areas."""
    ...
    def conduct_search(self, area_num, area_array, effecitveness_prob):
...
def main():
    ...
    if results_1 == 'Not Found' and results_2 == 'Not Found':
        print("\nNew Target Probablities (P) for Search {}:"
            .format(search_num + 1))
